                                ...
                                <form method="POST" action="{{route('admin.profile.store')}}" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" value="{{ $profileData->username }}"
                                            class="form-control" id="username" autocomplete="off" placeholder="Username">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="address" name="address" value="{{ $profileData->address }}"
                                    ...
                                    <div class="mb-3">
                                        <img class="wd-80 rounded-circle" id="showImage"
                                            src="{{ !empty($profileData->photo) ? url('imgs/admin_images/' . $profileData->photo) : url('imgs/no_image.jpg') }}"
                                            alt="profile">
                                        <span class="h4 ms-3 ">{{ $profileData->photo }}</span>
                                    </div>
